							...
							<CardContent>
								<TabsContent value="booklists" className="space-y-6">
									{Array.from({ length: 9 }).map((_, idx) => (
										<Card
											key={idx}
											className="flex items-center border-none shadow-none bg-transparent"
										>
											<Book src="/assets/images/600.webp" size="sm" />
											<CardHeader className="space-y-2.5 py-0">
												<CardTitle className="line-clamp-1">
													Người siêng năng cấp thần
												</CardTitle>
												...
												<CardDescription className="flex-grow line-clamp-1">
													...
													elit. Asperiores quisquam repellendus, quidem possimus
													nam, accusantium quaerat sunt delectus atque natus
													veniam temporibus. Ipsam voluptate harum eveniet
													tenetur ea delectus nostrum.
												</CardDescription>
												{/* Chapter */}
												<div className="flex items-center justify-between">
													<CardDescription className="line-clamp-1 text-xs font-medium">
														...
														<span className="text-foreground">
															Chương 2796: Cuốn sách mới "Một mình một kiếm"
															được phát hành!!
														</span>
													</CardDescription>
											...
											<Link
												...
												size="sm"
												variant="outline"
												className="flex-grow border-destructive"
											>
