			...
			<div className="relative min-h-screen z-[1] divide-y">
					...
					<Card className="bg-transparent text-center">
						...
						<CardContent>
							<CardDescription className="text-foreground/80">
								...
								Laudantium nesciunt dolor repellat labore enim mollitia quam
								repellendus! Corrupti deserunt explicabo aperiam laboriosam
								repellendus aliquam iure minima delectus adipisci, et soluta.
							</CardDescription>
						</CardContent>
					</Card>
				</section>
				...
				<section className="relative grid items-center w-[inherit] p-0 py-4 md:p-6">
					...
					<Card className="bg-transparent border-none">
						<CardHeader>
							<CardTitle className="text-foreground/80 line-clamp-1">
								Chương {params.chapterId}: ???
							</CardTitle>
							<div className="flex flex-wrap gap-3">
								<span className="flex items-center space-x-1">
									<Icons.notebook size={12} className="text-muted-foreground" />
									<CardDescription>
										Học thuyết gia tài năng hệ thống
									</CardDescription>
								</span>
								<span className="flex items-center space-x-1">
