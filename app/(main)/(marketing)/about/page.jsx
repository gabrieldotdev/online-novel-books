    ...
    <div className="grid content-center">
      <main className="container py-10 duration-700 animate-in fade-in slide-in-from-bottom-8">
        <div className="space-y-2">
          <h1 className={cnBase(typographyVariants(), "lg:text-4xl")}>
            {siteConfig.name}{" "}
            <span className="bg-gradient-to-r from-lime-600 to-green-600 bg-clip-text text-transparent">Website</span>
          </h1>
        ...
        <p className={typographyVariants({ size: "xs" })}>
          &copy; 2024{" "}
          <Link
            className="font-medium underline underline-offset-4"
            href="https://github.com/lilwxs"
            rel="noreferrer"
            target="_blank"
          >
            {siteConfig.author}
