...
import { FestivalCarousel } from "@/islands/navigation/carousels/festival-carousel";
...
import { options, slides } from "@/settings/other";

export default function Home() {
  return (
    <BaseShell as="div" className="py-0 md:py-0 space-y-8">
      {/* festival */}
      <Shell variant="compact" className="flex items-start justify-center gap-x-4">
        <section className="flex-shrink-0 w-80 hidden lg:block">
          <Card x-chunk="Top 10 Comics">
