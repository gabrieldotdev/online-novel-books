...
function BasicInfo({ item }) {
	return (
		<div className={cls("flex flex-1 justify-between", "items-center")}>
			<CardTitle className="leading-8 font-normal line-clamp-1">
				{item.name}
			</CardTitle>
...
function FullInfo({ item }) {
	return (
		<div className={cls("flex flex-1 justify-between", "items-start")}>
			<div className="flex flex-col space-y-1">
				<CardTitle className="font-normal leading-8 hover:text-destructive line-clamp-1">
					{item.name}
				</CardTitle>
