  ...
  return (
    <Card className="border-none shadow-none bg-white">
      <CardHeader className="flex flex-row items-center justify-between space-x-2 space-y-0">
        <CardTitle className="text-2xl shrink-0">Giới thiệu về cốt truyện</CardTitle>
        <div className="border-b border-dashed border-border w-full" />
      </CardHeader>
      <CardContent>
        <CardDescription className="font-medium leading-6">
          Tôi là một xác sống, một xác sống biết suy nghĩ. Là một xác sống, tôi chỉ cần sống một cách chậm rãi mỗi ngày.
          Bởi vì tôi rất yếu, không thể cạy cổ được những người lớn, đói đến mức mỗi ngày chỉ có thể sống mơ màng, đầu
          óc hầu như không thể vận động. Không thể cạy cổ được, ngoài việc sống mơ màng, nằm đó chẳng làm được gì khác
