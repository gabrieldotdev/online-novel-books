			...
			<CardHeader className="flex flex-row items-center justify-between space-y-0 space-x-2 p-2">
				...
				<div className="space-y-1.5 overflow-hidden">
					<CardTitle className="truncate">
						Huyết quỷ ma đa chuyển sinh
					</CardTitle>
					<CardDescription className="leading-4 line-clamp-2">
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut magnam
						placeat amet facere itaque ex velit id, laboriosam rem delectus
						aspernatur optio similique, excepturi illo dolor ipsam deserunt
						cupiditate ea.
					</CardDescription>
				</div>
				<div className="hidden group-hover:block">
					<Button
						size="chip"
						className="absolute top-2 right-2 bg-gray-100 hover:shadow-md"
					>
