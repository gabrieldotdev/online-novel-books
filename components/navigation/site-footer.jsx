  ...
  return (
    <Shell>
      <Card className="border-none shadow-none bg-transparent space-y-4">
        <CardHeader className="flex-row justify-between space-y-0 p-0">
          ...
          <section className="shrink-0 text-end space-y-3">
            <CardTitle className="text-sm">Về chúng tôi</CardTitle>
            <section className="space-y-1">
              <CardDescription className="text-xs">
                Chúng tôi cung cấp những thông tin mới nhất về công nghệ, giải trí và đời sống.
              </CardDescription>
            </section>
          </section>
        </CardHeader>
