...
export function ExtraNav() {
  ...
  return (
    <div className="h-[3.5rem] w-full">
      <Navbar isSticky={isSticky} className={isSticky ? "" : "border-b border-input"}>
        <LogoBrand isSticky={isSticky} color="dark:invert" />
        <MainNav items={siteConfig.mainNav} isSticky={isSticky} color="text-foreground/80" />
        <MobileNav items={siteConfig.mainNav} />
        <div className="flex flex-1 items-center  h-full space-x-3 justify-end">
          <Search />
          <CommandSearch />
          <ExtendNav items={siteConfig.extendNav} isSticky={isSticky} color="text-foreground/80" />
          <CreateNovel isSticky={isSticky} color="text-black/80 border-black/20" />
