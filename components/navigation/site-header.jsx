...
import { ElCategories } from "./categories/el-categories";

const Header = ({ children }) => <header className="relative z-50">{children}</header>;
...
export function SiteHeader() {
  ...
  return (
    <Header>
      ...
      <section className="relative -top-4 w-full">
        <ElCategories />
      </section>
    </Header>
  );
