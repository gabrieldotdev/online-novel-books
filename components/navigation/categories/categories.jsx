...
// import { Icons } fro../../iconsons";
// import { Button } fro../../primitives/buttonton";
...
//     <Shell
//       className={cls(
//         "flex items-start py-2 md:py-2 gap-0",
//         isListOpen &&
//           "absolute top-0 w-full left-1/2 transform -translate-x-1/2 rounded-br-xl rounded-bl-xl bg-white z-10",
//       )}
//     >
//       <div className={cls("flex space-x-2 flex-shrink-0", buttonVariants({ size: "sm" }))} style={{ padding: "0" }}>
...
//           )}
//         >
//           {allCategories.slice(0, isListOpen ? allCategories.length : maxVisible).map((category) => (
//             <Link
//               key={category.label}
//               href={category.href}
//               size="sm"
//               className={cls(
//                 isActive(category.href) ? "border border-dashed" : "bg-order text-foreground hover:bg-border",
//                 labelVariants(),
//               )}
//             >
//               {category.label}
...
//         {isListOpen ? <Icons.chevronUp size={16} /> : <Icons.chevronDown size={16} />}
//       </Button>
//     </Shell>
//   );
// }
