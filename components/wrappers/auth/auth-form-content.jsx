          ...
          <div className="flex flex-col space-y-2 text-center">
            ...
            {type === "login" ? (
              <p className="text-muted-foreground">
                hoặc{" "}
                <Link href="/register" className="underline hover:text-foreground duration-100 transition-colors">
                  Tạo tài khoản mới
                </Link>
              </p>
            ) : type === "register" ? (
              <p className="text-muted-foreground">
                Bạn đã có tài khoản?{" "}
                <Link href="/login" className="underline hover:text-foreground duration-100 transition-colors">
                  Đăng nhập ngay
                </Link>
              </p>
            ) : null}
