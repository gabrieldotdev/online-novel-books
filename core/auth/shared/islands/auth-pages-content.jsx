...
export function AuthPagesContent({ imageSrc, title, type = "signIn", className, children, ...props }) {
  return (
    <Shell
      className={cls(
    ...
    >
      ...
      <div className="relative hidden flex-col p-10 text-white lg:flex dark:border-r h-[calc(100dvh-4rem)] w-96 rounded-3xl overflow-hidden">
        ...
        <Image src={imageSrc} alt="" layout="fill" objectFit="cover" property />
        <div className="z-20 flex relative items-center justify-between text-lg font-medium">
          ...
          <Link href="/" className="group flex items-center space-x-2">
            ...
            <span className="flex items-center space-x-2 text-base text-white/80 group-hover:underline">Back</span>
          </Link>
        </div>
      </div>
          ...
          <div className="flex flex-col space-y-2 text-center">
            ...
            {type === "signIn" ? (
              <p className="text-muted-foreground">
                or{" "}
                <Link href="/sign-up" className="underline hover:text-foreground duration-100 transition-colors">
                  Create an account
                </Link>
              </p>
            ) : type === "signUp" ? (
              <p className="text-muted-foreground">
                ...
                <Link href="/sign-in" className="underline hover:text-foreground duration-100 transition-colors">
                  Sign in
                </Link>
              </p>
            ) : null}
